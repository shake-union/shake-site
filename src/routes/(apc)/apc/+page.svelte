	...
	<div class="container">
		<div class="row my-7">
			<div class="col-md-10 offset-md-1">
				...
				<ol>
					<li>
						(25.05.16) 참가자 계정 정보와 대회 일시 및 공지를 담은 메일이 발송되었습니다. 메일에 포함된 계정을 통해 백준 온라인 저지(BOJ) 로그인 하신 뒤, 예비 소집 대회를 진행해주시기 바랍니다.
					</li>
					<li>
						(25.05.16) 대회 당일 사용할 노트북과 필기구는 참가자가 직접 지참해야 합니다. 연습장은 대회장에서 스태프에 의해 제공되는 A4 용지만 사용할 수 있습니다.
					</li>
					<li>
						(24.05.16) 대회 당일 대회 관련 페이지와 지원 언어별 공식 레퍼런스 사이트를 제외한 어떤한 외부 사이트의 접속과 AI의 사용을 금합니다. 이는 온라인 IDE를 포함합니다.
						<br> 따라서, 참가자분들께서는 오프라인 컴파일 환경을 준비하여 주시기 바랍니다.
					</li>
					<li>
						(25.05.15) 예비 소집 대회는 안내될 참가자 계정을 통해 로그인하여 참가할 수 있습니다. 참가자 계정 안내 시 공지 드리겠습니다.
					</li>
					<li>
						(25.05.15) Division 1,2 모두 문항은 출제진이 판단한 난이도 순으로 정렬되어 있습니다.
						<ul>
							<li>
								Division 1의 경우, 출제진이 예상한 첫 번째 문항의 난이도는 Silver(solved.ac 기준)입니다.
							</li>
							<li>
								Division 2의 경우, 출제진이 예상한 첫 번째 문항의 난이도는 Bronze(solved.ac 기준)입니다.
							</li>
						</ul> 
					</li>
					<li>
						(25.05.15) 참가자 신청 기간이 종료되었습니다. 건승을 빕니다!
					</li>
					<li>
		...
		<div class="row my-7">
			<div class="col-md-10 offset-md-1">
				...
				<ul>
					...
					<li>
						<b>하드 카피를 허용합니다. 단면 인쇄로 최대 25장 까지 가능합니다.</b>사전에 인쇄해서 대회 당일 가져오신 후 스태프에게 검사를 맡은 후 사용해 주시면 됩니다.
					</li>
					...
					<li>
						...
						<ul>
							...
							<li>
								Division 2 : 소프트웨어융합대학 혹은 첨단ICT융합대학 소속이 아닌 자
							</li>
							<li>
				...
				<div class="row">
					<div class="col-md-10 offset-md-1">
						...
						<ul>
							...
							<li>
								사용가능한 프로그래밍 언어는 <strong>C/C++, Java, Python3, PyPy3</strong>로
							...
							<li>
								대회 중 문제 및 채점에 관한 질문은 대회 진행 페이지의 문의하기 기능을 통해 문의해야
								합니다.
							</li>
						...
						<ul>
							...
							<li>
								제출한 답이 해당 문제 최초 정답인 경우, 제출자에게 <strong
									>(대회 경과 시간) + (해당 문제 오답 제출 수 x 20분)</strong
								>의 패널티를 가산합니다.
							</li>
